      ...
      <div className="relative z-10 min-h-screen flex flex-col p-4 md:p-12">
        ...
        <header className="max-w-6xl mx-auto w-full flex justify-between items-center mb-10">
          ...
          <div className="flex gap-4 items-center">
            <div className="text-right hidden xs:block">
              ...
              <div className="w-24 md:w-40 h-1 bg-white/5 rounded-full overflow-hidden">
                <div className="h-full bg-rose-600 transition-all duration-500" style={{ width: `${hp}%` }}></div>
              </div>
            </div>
        ...
        <main className="flex-1 flex flex-col items-center justify-center max-w-4xl mx-auto w-full pb-10">
          {gameState === "playing" ? (
            ...
            /* --- RE-OPTIMIZED SYSTEM MESSAGE (Mobile Fixed) --- */
            <div className={`monarch-msg p-8 md:p-20 w-full max-w-[95%] md:max-w-2xl text-center space-y-6 md:space-y-10 animate-in zoom-in duration-500 ${gameState === 'lost' ? '!border-rose-500' : ''}`}>
